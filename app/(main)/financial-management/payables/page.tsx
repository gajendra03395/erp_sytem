...
import type { Invoice, Vendor } from '@/types/financial'
...
export default function AccountsPayablePage() {
  ...
  const fetchPayablesData = async () => {
    ...
    try {
      const [invoicesRes, vendorsRes] = await Promise.all([
        fetch('/api/financial-management/payables'),
        fetch('/api/financial-management/vendors')
      ])
  ...
  const overdueAmount = invoices
    .filter(inv => inv.type === 'payable' && inv.status === 'overdue')
    .reduce((sum, inv) => sum + inv.balanceAmount, 0)
    ...
    <div className="container mx-auto p-6 space-y-6">
            ...
            <Dialog open={showInvoiceDialog} onOpenChange={setShowInvoiceDialog}>
              ...
              <DialogContent className="max-w-2xl">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Add a new vendor invoice to your accounts payable.
                  </DialogDescription>
                </DialogHeader>
                <InvoiceForm 
                  type="payable" 
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              All outstanding vendor invoices
            </p>
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage all accounts payable invoices</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
                ...
                <TableRow key={invoice.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      {vendors.find(v => v.id === invoice.vendorId)?.name || 'Unknown Vendor'}
                    </div>
                  </TableCell>
...
function InvoiceForm({ type, vendors, onClose }: { 
